...
data ShelleyGenesisCmdError
  ...
  | ShelleyGenesisStakePoolRelayGetNetworkIdError !EnvNetworkIdError
  deriving Show
  ...
  displayError err =
    case err of
      ...
      ShelleyGenesisStakePoolRelayJsonDecodeError fp e ->
        ...
        " Error: " <>  e
      ShelleyGenesisStakePoolRelayGetNetworkIdError e -> displayError e
...
runGenesisCmd (GenesisCreateCardano gd gn un ms am k slotLength sc nw bg sg ag mNodeCfg) = do
  network <- getNetworkId nw ShelleyGenesisCmdGetNetworkIdError
...
runGenesisCreateStaked (GenesisDir rootdir)
                 ...
                 sPoolRelayFp = do
  network <- getNetworkId networkArg ShelleyGenesisStakePoolRelayGetNetworkIdError
  liftIO $ do
    createDirectoryIfMissing False rootdir
    createDirectoryIfMissing False gendir
    createDirectoryIfMissing False deldir
